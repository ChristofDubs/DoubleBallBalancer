...
class Controller(object):
    ...
    def __init__(self, _):
        self.K = np.array(
            [0.0, 26.62771567, -199.45731763, -327.80147739, -1.23606798, 9.73717718, -133.08516459, -137.62380736]
        )
        self.kp = 0.2
        self.kd = 0.2
    ...
    def compute_ctrl_input(self, x, beta_cmd, mode=ANGLE_MODE):
        ...
        phi_des = (
            1
            / self.K[StateIndex.PHI_IDX]
            * (
                beta_ddot_des
                - self.K[StateIndex.PSI_1_IDX] * x[StateIndex.PSI_1_IDX]
                - self.K[StateIndex.PSI_DOT_1_IDX] * x[StateIndex.PSI_DOT_1_IDX]
                - self.K[StateIndex.PSI_0_IDX] * x[StateIndex.PSI_0_IDX]
        ...
        phi_dot_des = (
            self.K[StateIndex.PHI_IDX] * (phi_des - x[StateIndex.PHI_IDX])
